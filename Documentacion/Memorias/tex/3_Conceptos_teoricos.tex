...
\item Gabor
\end{itemize}
Aparte de los métodos antes mencionados hemos combinado distintos formas para detectar bordes através de los autovectores largos, de la matriz Hessiana.