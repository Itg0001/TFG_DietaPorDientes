...
\begin{figure}
	...
	\centering\large \includegraphics[width=.9\textwidth]{velocitip1}
	\caption{Grafica de los sprints del 0 al 7.}\label{fig:orip1}
	\end{subfigure}%
	\begin{subfigure}[c]{.5\linewidth}
	\centering\large \includegraphics[width=.9\textwidth]{velocitip2}
...
Personal         & 5\,060 \euro{}   \\ 
Seguridad Social & 1\,513\euro{} \\ 
Material         & 79.9\euro{}   \\ 
Totales             & 6\,713\euro{} \\ \bottomrule
\end{tabular}
%}
\end{table}
