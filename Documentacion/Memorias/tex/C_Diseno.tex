...
\begin{figure}[h]
	\centering
	\includegraphics[width=.99\textwidth]{DiagramaClasesFinalP1}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.99\textwidth]{DiagramaClasesFinalP2}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.99\textwidth]{DiagramaPaquetesV2}
	\caption{Diagrama de paquetes inicial}
